...
QT_MOC_LITERAL(1, 9, 21), // "onSerialPortReadyRead"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "Emission\0onSerialPortReadyRead\0"
};
...
void Emission::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Emission *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Emission::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Emission.data,
    qt_meta_data_Emission,
    qt_static_metacall,
    nullptr,
    nullptr
} };
